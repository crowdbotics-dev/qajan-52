"""
Django settings for qajan_52 project.
...
WSGI_APPLICATION = 'qajan_52.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "qajan_52 API",
    "DESCRIPTION": "API documentation for qajan_52 App",
    "VERSION": "v1",
}
